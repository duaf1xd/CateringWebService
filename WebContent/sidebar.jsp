   <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">CWS Admin</div>
            </a>
...
-->
 ...
 -->
            ...
            <li class="nav-item active">
                <a class="nav-link" href="AdminManageItemServlet">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="AdminViewRequestServlet">
                    <i class="fas fa-fw fa-folder"></i>
            ...
            <!-- Nav Item - Charts -->
            <li class="nav-item active">
                <a class="nav-link" href="AdminManageCouponServlet">
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item active">
                <a class="nav-link" href="CustomerServlet">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Manage Customer</span></a>
            </li>
           <li class="nav-item active">
              <a class="nav-link" href="LogoutServlet"><i class="fas fa-sign-out-alt"></i><span>Logout</span></a></a>
</li>
            <!-- Divider -->
