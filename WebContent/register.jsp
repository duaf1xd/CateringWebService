                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" action = "RegisterCustomerServlet" method = 'post'>
                                <div class="form-group row">
                                   ...
                                   <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control form-control-user" id="exampleLastName" name= "phoneNumber"
                                   ...
                                   <div class="col-sm-6">
                                        <input type="date" class="form-control form-control-user" id="exampleLastName" name = "dob" min="1900-04-01" max="2021-12-30"
