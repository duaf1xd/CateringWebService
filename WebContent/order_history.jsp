	...
	<!-- Top box -->
		...
		<main>
			...
			<header class="row tm-welcome-section">
				<h2 class="col-12 text-center tm-section-title">ORDER HISTORY</h2>
 ...
 <div class="alert alert-danger alert-dismissible fade show">
        ...
        <button type="button" class="close" data-dismiss="alert">&times;</button>
			...
			<div class="tm-paging-links">
				<nav>
					<ul>
					<li class="tm-paging-item"><a href="#" class="tm-paging-link">HOMEPAGE</a></li>
...
%>
					<article class="col-lg-3 col-md-4 col-sm-6 col-12 tm-gallery-item">
						<figure>
							...
							<figcaption>
								<h4 class="tm-gallery-title"><%=item.getName() %></h4>
								<p class="tm-gallery-description"><%=item.getDescription() %></p>
								<p class="tm-gallery-price"><%=item.getPrice() %> $</p>
								<!--  ${item.request.getRequestTime()}-->
								
								<p class="tm-gallery-price"><%=DateUtil.timeToString(item.getRequest().getRequestTime())%></p>
