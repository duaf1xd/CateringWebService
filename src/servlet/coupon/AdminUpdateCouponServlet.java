...
/**
 * Servlet implementation class AdminUpdateCoupon
 */
@WebServlet("/AdminUpdateCouponServlet")
public class AdminUpdateCouponServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminUpdateCouponServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (username == null) {
			...
			//cannot change id, code, currentUsageCount
			...
			request.setAttribute("success", "Update Coupon Successfully!");
